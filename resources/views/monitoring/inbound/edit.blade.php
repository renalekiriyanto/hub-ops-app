            ...
            <div class="col">
                <div class="card card-primary card-outline mb-4">
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Inbound</h3>
                    </div>
                    <form action="{{ route('monitoring.inbound.update', $inbound->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror"
                                    id="date" name="date" value="{{ old('date', $inbound->date) }}" required />
                                @error('date')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local"
                                    ...
                                    name="arrival_time" value="{{ old('arrival_time', $inbound->arrival_time) }}" required />
                                @error('arrival_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('slot_name') is-invalid @enderror"
                                    id="slot_name" name="slot_name" value="{{ old('slot_name', $inbound->slot_name) }}"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox"
                                        ...
                                        {{ old('is_additional_slot', $inbound->is_additional_slot) ? 'checked' : '' }} />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total_order') is-invalid @enderror"
                                    id="total_order" name="total_order" value="{{ old('total_order', $inbound->total_order ?? 0) }}"
                                    min="0" />
                                @error('total_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total_bulky') is-invalid @enderror"
                                    id="total_bulky" name="total_bulky" value="{{ old('total_bulky', $inbound->total_bulky ?? 0) }}"
                                    min="0" />
                                @error('total_bulky')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total_bag') is-invalid @enderror"
                                    id="total_bag" name="total_bag" value="{{ old('total_bag', $inbound->total_bag ?? 0) }}" min="0" />
                                @error('total_bag')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
